...
6. Call `plan_start_execution` with inline/background mode and commit-per-phase/no-commit policy. Report the execution ID and whether the foreground mode changed.
