...
2. Ground the plan in repository files and the explicit prompt. If no prompt was supplied, use the inherited conversation context supplied by the named Planner RPC dispatch.
