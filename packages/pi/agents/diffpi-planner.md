...
thinking: high
tools: read, grep, find, write, Agent, get_subagent_result, steer_subagent, ask_user_question, plan_context, plan_init, plan_update_overview, plan_add_phase, plan_remove_phase, plan_update_phase, plan_validate, plan_annotations, diffpi_modes_set, diffpi_modes_unset
metadata:
  model-tier: frontier
---
...
- Export annotations to a revision file before applying update instructions.
